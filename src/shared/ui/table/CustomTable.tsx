...
export default function CustomTable<T>({ table, hidePagination, className, embedded }: CustomTableI<T>) {
            ...
            <tr key={hg.id}>
              {hg.headers.map((header: any) => (
                <th
                  ...
                  className="px-4 py-3.5 text-left cursor-pointer select-none font-semibold text-[#1D3557]"
                >
